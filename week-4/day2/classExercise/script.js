...
// function starWars(nasaRocket){
//    let character = []
// 	                                     // default param
//   function createCharacter(fname, lname = "smith"){
//   	  let fullName = `${fname} ${lname}`
//       character.push(fullName)
//    }

// 	function displayCharacter(){
// 	    character.forEach((element) => {
// 	      let div = document.createElement("div")
// 		  let text = document.createTextNode(`${element} is in the ${nasaRocket}`)
// 		   div.appendChild(text) 
...
// 	 createCharacter("hans", "solo ")
// 	 createCharacter("alex")
// 	 createCharacter("robo", "cop ")
// 	 displayCharacter()
